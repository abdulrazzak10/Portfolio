...
function mapMetaDataInHeader() {
    ...
    tagElement.innerText = 'Computer Scientist';


    let firstName = 'Abdul Razzak';
    let lastName = 'Ghouri';
    ...
    let socials = [
        {
            ...
            "value": "https://www.linkedin.com/in/abdul-razzak-ghouri-a3068726a/"
        },
        {
            "icon": "fa fa-github",
            "value": "https://github.com/abdulrazzak10"
        },
        ...
        // },
        {
            ...
            "value": "https://instagram.com/iamabdulrazzakghouri"
        },
        // {
        //     "icon": "fa fa-twitter",
...
function mapStatsData() {
    let stats = [
        ...
        {
            "value": "~1x",
            "text-1": "Microsoft Azure fest",
            "text-2": "Hackathon Winner"
        },
        {
            "value": "~3x",
            "text-1": "Chess.com",
            "text-2": "Tournament Winner"
        }
    ];
